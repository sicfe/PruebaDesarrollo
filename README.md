...
3. Abre el archivo CalculadoraFacturacion.cs y completa el método CalcularTotales para calcular el monto total facturado y el monto total de impuestos para cada RUC.
